...
This document archives research questions that have been successfully investigated and resolved. Questions are preserved here for reference and to document the source tracing process.

> **See also**: [research_questions.md](research_questions.md) for open questions requiring investigation.
...
**Resolution Document**: `data/02_Swedenborgian_Theology/Bundahišn's Damdat Nask Reconstruction.md`

**Context**:
SWED-042 claims the DAMDAT NASK was a "systematic correspondence encyclopedia" destroyed at Persepolis.
...
**Resolution Document**: `data/02_Swedenborgian_Theology/Alexander, Persepolis, and Avestan Texts.md`

**Context**:
SWED-042 claims Alexander's destruction of Persepolis resulted in loss of Zoroastrian archives.
...
**Framework Implication:**
SWED-042 updated to clearly distinguish:
...
**Resolution Document**: `data/03_Biblical_Scholarship/Daniel_ Historicity and Cultural Synthesis.md`

**Context**:
SWED-043 originally claimed Daniel was appointed "Rab-mag" (Chief of Magi).
